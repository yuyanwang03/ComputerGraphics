...
void Application::OnKeyPressed( SDL_KeyboardEvent event )
{
	...
	switch(event.keysym.sym) {
        ...
        case SDLK_LEFT: {if (currentSection==section3_5) {this->animation.ChangeDirection(false);} break;}
        case SDLK_RIGHT: {if (currentSection==section3_5) {this->animation.ChangeDirection(true);} break;}
	}
}
